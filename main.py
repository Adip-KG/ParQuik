...
cred = credentials.Certificate("parquick-d18f1-firebase-adminsdk-abc1y-04e444094a.json")

firebase_admin.initialize_app(cred,{
'databaseURL':'https://parquick-d18f1-default-rtdb.firebaseio.com'
})

# save data
ref = db.reference('ParQuick')
spot_ref = ref.child('spot')
